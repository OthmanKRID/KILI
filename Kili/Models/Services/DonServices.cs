    ...
    public class DonServices
    {
        ...
        public void SupprimerDonateur(int id)
        {
            ...
            if (donateur != null)
            {
                ...
                UserAccount_Services.ModifierUserAccount(compte.Id, compte.Prenom, compte.Nom, compte.Telephone, compte.Mail, compte.Role, compte.AssociationId, null, compte.ImagePath);
                _bddContext.SaveChanges();
            }
        }
